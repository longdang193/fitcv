...
| Bookmarks | Bookmarks workspace, search/filter, revisit, remove, CSV/full-data export | `/bookmarks`, remove, export preview/export, full export, run-job bookmark mutations | **Aligned.** Preserve bookmark identity, selection preview, filtered CSV/full-data export, and dependent-removal truth. | Job Evaluation and Personalization |
