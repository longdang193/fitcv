...
---
# rule_filter - key-decisions

START

T-F_Obsidian-v2

Q: rule_filter stage - Key decisions: What important choices or judgments happen in this stage?

A: Hard reject vs non-blocking mark classification with finalized reject reasons.
