...
Q: normalize stage - Purpose: What does this stage do, and why does it exist?

A: Normalize raw inputs into stable deduplicated rows; it is boundary where raw shape ends.
