...
## cv_analysis - key-decisions

SSTART

T-F_Obsidian-v2

Q: cv_analysis stage - Key decisions: What important choices or judgments happen in this stage?

A: Bounded evidence bundle selection and fit-gate resolution for each ranked job.
