...
Q: ranking stage - Mental model: What is the best way to think about this stage conceptually?

A: Decision-contract stage, not only numeric sorting stage.
