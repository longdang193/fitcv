...
| G replay modes/policy registry | partial | outbox replay check endpoints + scripts (`85c6ebe`, `81e638f`) | Replay-health policy behavior exists; broader policy registry/replay-mode governance remains incomplete. |
