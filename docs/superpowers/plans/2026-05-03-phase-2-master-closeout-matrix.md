...
| Langfuse integration (roadmap deliverable) | done | provider/runtime integration + implementation checkpoints (`20260504-0130`, `20260505-0940`, `20260505-1015`) + targeted telemetry/run-detail tests | Wave 3 blocker was resolved with bounded run-detail trace endpoint availability guards; targeted and governance verification now pass in current branch state. |
