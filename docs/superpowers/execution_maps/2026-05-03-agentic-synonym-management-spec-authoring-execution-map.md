...
specs:
  ...
  - docs/superpowers/specs/2026-05-01-agent-based-synonym-triage-recommendation-service-spec.md
...
# Spec Authoring Execution Map (workstream-agentic-synonym-management)

Lifecycle map to satisfy planning lineage coverage for `workstream-agentic-synonym-management`.
