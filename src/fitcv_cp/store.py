...
class RunStore(Protocol):
    ...
    def create_candidate_profile_edit_attempt(self, profile_id: str, *args: Any, **kwargs: Any) -> dict[str, Any]: ...
    ...
    def discard_candidate_profile_creation_attempt(self, attempt_id: str, **kwargs: Any) -> dict[str, Any]: ...
...
class ControlPlaneStore:
    ...
    discard_candidate_profile_creation_attempt_fn: Any | None = None
    ...
    def create_candidate_profile_edit_attempt(self, profile_id: str, *args: Any, **kwargs: Any) -> dict[str, Any]:
        return self._call_dict(
            getattr(self, "create_candidate_profile_edit_attempt_fn", None),
            sqlite_store.create_candidate_profile_edit_attempt,
    ...
    def discard_candidate_profile_creation_attempt(self, attempt_id: str, **kwargs: Any) -> dict[str, Any]:
        return self._call_dict(
            self.discard_candidate_profile_creation_attempt_fn,
