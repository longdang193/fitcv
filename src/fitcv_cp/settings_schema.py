...
SETTINGS_SCHEMA: list[dict[str, Any]] = [
    ...
    {
        "key": "reuse_policy.enrich_reuse_enabled",
        "type": "bool",
        "default": True,
        "label": "Enrich Reuse Enabled",
        "description": "Reuse compatible cached enrichment rows; disable to force fresh enrich extraction.",
        "group": "retrieval",
        "config_path": ["reuse_policy", "enrich_reuse_enabled"],
    },
    {
        "key": "reuse_policy.ai_score_reuse_enabled",
        "type": "bool",
        "default": True,
        "label": "AI Score Reuse Enabled",
        "description": "Reuse compatible AI score rows from prior snapshots; disable to force fresh scoring.",
        "group": "retrieval",
        "config_path": ["reuse_policy", "ai_score_reuse_enabled"],
    },
    {
        "key": "reuse_policy.evidence_reuse_enabled",
        "type": "bool",
        "default": True,
        "label": "Evidence Reuse Enabled",
        "description": "Reuse in-request semantic embedding cache during evidence retrieval; disable to force fresh embedding calls.",
        "group": "retrieval",
        "config_path": ["reuse_policy", "evidence_reuse_enabled"],
    },
    {
