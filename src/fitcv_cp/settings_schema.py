...
SETTINGS_SCHEMA: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "description": "Visibility intent for Education. Effective inclusion also depends on meaningful profile education data.",
        "group": "cv_composition",
    ...
    },
    {
        ...
        "description": "Visibility intent for Certifications. Effective inclusion depends on eligible selected-evidence certifications.",
        "group": "cv_composition",
    ...
    },
    {
        ...
        "description": "Visibility intent for Languages. Effective inclusion also depends on meaningful profile language data.",
        "group": "cv_composition",
